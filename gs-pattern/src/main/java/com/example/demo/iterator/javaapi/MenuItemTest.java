...
public class MenuItemTest {
    public static void main(String[] args) {
        ...
        SushiRestaurantMenu sushiRestaurantMenu = new SushiRestaurantMenu();

        List<Iterator<MenuItem>> list = Arrays.asList(cakeShopMenu.getIterator(), westRestaurantMenu.getIterator(), sushiRestaurantMenu.getIterator());
