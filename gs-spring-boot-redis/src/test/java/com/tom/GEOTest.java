...
public class GEOTest {
    ...
    public void test() {
        ...
        for (GeoResult geoResult : content) {
            logger.info("{}", geoResult.getContent());
        }
    ...
    private GeoResults getNearByXY(Point point, Distance distance) {
        ...
        logger.info("根据坐标获取：{} {} 范围的数据：{}", point, distance, geoResults);
        return geoResults;
    }
    ...
    private GeoResults getNearByPlace(String name, Distance distance) {
        ...
        logger.info("根据位置：{} 获取： {} 范围的数据：{}", name, distance, geoResults);
        return geoResults;
    }
    ...
    private List<String> getGeoHash(String... names) {
        ...
        logger.info("names：{} 对应的hash：{}", names, hash);
        return hash;
    }
}