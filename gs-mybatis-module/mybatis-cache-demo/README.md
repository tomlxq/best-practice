2018年01月19日 作者: 凯伦 [文章链接](https://tech.meituan.com/2018/01/19/mybatis-cache.html) 18778字 38分钟阅读
...
![img](doc/img/793031d0.jpg)

有若干个实现类，使用装饰器模式互相组装，提供丰富的操控缓存的能力，部分实现类如下图所示：

![img](doc/img/cdb21712.jpg)
